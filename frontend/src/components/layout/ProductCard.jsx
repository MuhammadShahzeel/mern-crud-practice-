    ...
    <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg border border-gray-700 flex flex-col transition-all duration-300 hover:shadow-xl hover:translate-y-[-5px]">
      ...
      <div className="p-4 flex flex-col justify-between flex-1">
        ...
        <div className="flex space-x-3 mt-4 justify-end">
          <button className="p-2 rounded-full bg-green-600 hover:bg-green-700 text-white transition-colors">
            <FiEdit2 size={20} />
          </button>
          <button onClick={handleDelete} className="p-2 rounded-full bg-red-600 hover:bg-red-700 text-white transition-colors">
            <FiTrash2 size={20} />
          </button>
        </div>
      </div>
